...
| `W1-DATA-14` | `docs/product/nutrition-quality-expansion/14_WAVE1_PHYSICAL_DATA_MODEL.md` | Exact tables, fields, types, constraints, ownership, versions, and legacy semantics | Approved | Engineering / Data | Engineering / Data | `2026-07-16` | `1.0` | Pending until approval commit | `W1-ADR-13`, `DEC-H01`, `DEC-H02`, `DEC-H03`, `DEC-H04`, `DEC-H05`, `DEC-H06`, `DEC-H07`, `DEC-H08`, `ADR-DIR-H09`, `ADR-DIR-H10`; governing decisions | None | Critical 0; High 0; Product decisions 0; review `14A_WAVE1_PHYSICAL_DATA_MODEL_REVIEW.md` | Yes | Yes |
