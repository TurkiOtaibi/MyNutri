...
| `AUDIT-07` | `docs/product/nutrition-quality-expansion/07_PRODUCT_DECISION_RECONCILIATION.md` | Supporting decision-to-baseline reconciliation evidence; not an implementation contract | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`; implemented baseline | Prior provisional 07 result | Unpinned; C01, C02, H01-H11 open at audit |
| `READINESS-08` | `docs/product/nutrition-quality-expansion/08_WAVE1_READINESS_RECHECK.md` | Supporting readiness and gap evidence; not an implementation contract | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `AUDIT-07` | Prior provisional 08 result | Unpinned; Critical 2; High 11 |
| `PLAN-09` | `docs/product/nutrition-quality-expansion/09_WAVE1_CRITICAL_HIGH_RESOLUTION_PLAN.md` | Supporting issue-resolution governance plan; not an implementation contract | Draft | Pending | Pending | Pending | Pending | Pending | `AUDIT-07`, `READINESS-08` | None | Unpinned; C01, C02, H01-H11 |
| `DEC-C01-10` | `docs/product/nutrition-quality-expansion/10_C01_APPROVED_PRODUCT_OWNER_DECISION.md` | Records approved C01 Product Owner direction | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09` | None | Record unpinned; C01 technical completion open |
| `DEC-C02-11` | `docs/product/nutrition-quality-expansion/11_C02_APPROVED_PRODUCT_OWNER_DECISION.md` | Records approved C02 Product Owner direction and package structure | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10` | None | Record unpinned; C02 package completion open |
| `DEC-H01` | `docs/product/nutrition-quality-expansion/13_H01_APPROVED_PRODUCT_OWNER_DECISION.md` | Records approved H01 Product Owner direction for cut intensity, deficit cap, and low-energy safety outcomes | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09` | Prior H01 recommendation only | Record unpinned; H01 technical completion open |
| `DEC-H02` | `docs/product/nutrition-quality-expansion/14_H02_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Records approved H02 Product Owner and contract direction for BMI-aware protein calculation and basis disclosure | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-H01` | Prior H02 recommendation only | Record unpinned; exact schema types and H02 technical completion open |
| `DEC-H03` | `docs/product/nutrition-quality-expansion/H03_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Contract Direction for carbohydrate warnings, rejection, compatibility, and legacy inventory | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-H01`, `DEC-H02` | Prior H03 recommendation only | Record unpinned; H03 technical completion and inventory open |
| `DEC-H04` | `docs/product/nutrition-quality-expansion/H04_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Lifecycle Direction for the hybrid immutable Target Plan and activation lifecycle | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10`, `DEC-H01`, `DEC-H02`, `DEC-H03` | Prior H04 recommendation only | Record unpinned; exact schema, timezone, API, migration, transaction, and H04 technical completion open |
| `DEC-H05` | `docs/product/nutrition-quality-expansion/H05_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Registry Direction for the canonical 16-nutrient Backend Registry and compatibility semantics | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-H04` | Prior H05 recommendation only | Record unpinned; exact types, endpoint, cache, migration, UX, implementation, and H05 verification open |
| `DEC-H06` | `docs/product/nutrition-quality-expansion/H06_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Food-Group Direction for normalized contributions, traits, serving rules, and coverage semantics | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10`, `DEC-H05` | Prior H06 recommendation only | Record unpinned; exact schema, API, migration, Arabic UI, implementation, and H06 verification open |
| `DEC-H07` | `docs/product/nutrition-quality-expansion/H07_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Source/NOVA Direction for controlled sources, derived reliability, ingredients, NOVA, and historical interpretation | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10`, `DEC-H05`, `DEC-H06` | Prior H07 recommendation only | Record unpinned; exact schema, API errors, caching, UI transitions, migration, implementation, and H07 verification open |
| `DEC-H08` | `docs/product/nutrition-quality-expansion/H08_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Snapshot Direction for Snapshot v2, relational ownership, Target Plan binding, compatibility, and rollout semantics | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10`, `DEC-H04`, `DEC-H05`, `DEC-H06`, `DEC-H07` | Prior H08 recommendation only | Record unpinned; exact physical fields, JSON schema, endpoint envelopes, migration, rollout, UX, implementation, and H08 verification open |
| `ADR-DIR-H09` | `docs/product/nutrition-quality-expansion/H09_APPROVED_ARCHITECTURE_MIGRATION_DIRECTION.md` | Approved Architecture/Migration Direction for Alembic authority, ordered rollout, fail-closed ownership migration, compatibility, and rollback | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-C01-10`, `DEC-H04`, `DEC-H05`, `DEC-H06`, `DEC-H07`, `DEC-H08` | Prior H09 recommendation only | Record unpinned; exact physical schema, revisions, provisioning implementation, CI commands, migration evidence, and H09 verification open |
| `ADR-DIR-H10` | `docs/product/nutrition-quality-expansion/H10_APPROVED_RULE_VERSIONING_DIRECTION.md` | Approved Architecture/Rule-Versioning Direction for Backend rule ownership, independent versions, manifest integrity, Registry exposure, and historical interpretation | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-H04`, `DEC-H05`, `DEC-H06`, `DEC-H07`, `DEC-H08`, `ADR-DIR-H09` | Prior H10 recommendation only | Record unpinned; exact modules, physical fields, API envelope, caching, implementation, migration, and H10 verification open |
| `DEC-H11` | `docs/product/nutrition-quality-expansion/H11_APPROVED_PRODUCT_OWNER_DIRECTION.md` | Approved Product/Truthful-Aggregation Direction for null, zero, coverage, target evaluation, and Frontend authority | Draft | Pending | Pending | Pending | Pending | Pending | `PDR-V1.1`, `PLAN-09`, `DEC-H05`, `DEC-H08`, `ADR-DIR-H10` | Prior H11 recommendation only | Record unpinned; exact API schema, Backend implementation, Arabic UI, compatibility, and H11 verification open |

The decisions and directions recorded in artifacts 10, 11, the H01 through H08 and H11 decision records, `ADR-DIR-H09`, and `ADR-DIR-H10` are approved governance evidence. Their current local files remain `Draft` freeze records because they are uncommitted and have no pinned revision, named approver, or approval date.
...
Artifacts 13-21 do not exist in the current repository state. They are listed as `Not Created` and are not created by this task.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---:|---:|
| `W1-ADR-13` | `docs/product/nutrition-quality-expansion/13_WAVE1_ARCHITECTURE_SECURITY_ADRS.md` | Architecture, security, Principal ownership, rule authority, and system-boundary ADRs | Not Created | Pending | Pending | Pending | Pending | Pending | `DEC-C01-10`, `DEC-C02-11`, `DEC-H01`, `DEC-H02`, `DEC-H03`, `DEC-H04`, `DEC-H05`, `DEC-H06`, `DEC-H07`, `DEC-H08`, `ADR-DIR-H09`, `ADR-DIR-H10`, `DEC-H11` | None | C01; H04-H11 | Yes | Yes |
