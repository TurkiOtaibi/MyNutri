...
| `W1-CD-01` | `docs/product/nutrition-quality-expansion/W1-CD-01_APPROVED_LEGACY_TARGET_TRANSITION_SNAPSHOT.md` | Approved clarification preserving the transition-date legacy target during first Target Plan activation | Approved | `1.0` | Pending | Product Owner / Architecture / Engineering-Data / API | Product Owner / Architecture / Engineering-Data / API | `2026-07-16` | `DEC-H04`, `W1-ADR-13`, `W1-DATA-14`, `W1-API-15`, `W1-MIG-16` | None | Approved but re-pin pending; review `W1-CD-01A_LEGACY_TARGET_TRANSITION_IMPACT_REVIEW.md` |
...
| `W1-DATA-14` | `docs/product/nutrition-quality-expansion/14_WAVE1_PHYSICAL_DATA_MODEL.md` | Exact tables, fields, types, constraints, ownership, versions, and legacy semantics | Approved | Engineering / Data | Engineering / Data | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, `W1-ADR-13`, approved directions | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
| `W1-API-15` | `docs/product/nutrition-quality-expansion/15_WAVE1_API_CONTRACTS.md` | Requests, responses, errors, nulls, idempotency, ownership, and compatibility | Approved | API / Architecture | API / Architecture | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, `W1-ADR-13`, `W1-DATA-14`, approved directions | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
| `W1-MIG-16` | `docs/product/nutrition-quality-expansion/16_WAVE1_MIGRATION_ROLLBACK_PLAN.md` | Expand-Migrate-Contract, rollback, realistic rehearsal, and legacy protection | Approved | Engineering / Data / Operations | Engineering / Data / Operations | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, `W1-ADR-13`, `W1-DATA-14`, `W1-API-15` | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
| `W1-BAQA-17` | `docs/product/nutrition-quality-expansion/17_WAVE1_USER_STORIES_ACCEPTANCE_CRITERIA.md` | Testable user stories and positive/negative acceptance criteria | Approved | Product / BA / UX | Product / BA / UX | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, approved decisions, `W1-ADR-13` through `W1-MIG-16` | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
| `W1-GOLDEN-18` | `docs/product/nutrition-quality-expansion/18_WAVE1_GOLDEN_CALCULATIONS.md` | Fixed calculation, target, boundary, warning, rejection, null, and legacy scenarios | Approved | Engineering / QA | Engineering / QA | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, approved decisions, `W1-API-15`, `W1-BAQA-17` | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
...
| `W1-VERIFY-20` | `docs/product/nutrition-quality-expansion/20_WAVE1_VERIFICATION_REGRESSION_PLAN.md` | Focused, migration, security, compatibility, baseline regression, and release evidence | Approved | QA / Security / Engineering | QA / Security / Engineering | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, approved decisions, `W1-ADR-13` through `W1-UI-19` | Version 1.0 | Approved but re-pin pending; Critical 0; High 0 | Yes | Yes |
| `W1-TRACE-21` | `docs/product/nutrition-quality-expansion/21_WAVE1_TRACEABILITY_MATRIX.md` | Decision-to-contract-to-story-to-test-to-closure traceability | Approved | BA / QA / Governance | BA / QA / Governance | `2026-07-16` | `1.1` | Pending | `W1-CD-01`, governing sources, `W1-ADR-13` through `W1-VERIFY-20` | Version 1.0 | Approved but re-pin pending; gaps 0 | Yes | Yes |
