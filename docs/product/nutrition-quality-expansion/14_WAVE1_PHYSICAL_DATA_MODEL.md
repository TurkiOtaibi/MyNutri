...
> Plan lifecycle schema is also superseded. Authentication, authorization,
> nutrient-nullability, and unaffected calculation requirements remain applicable
> only where they do not conflict with current authority.
